...
export default async function ExerciseDetailPage({ params }: ExerciseDetailPageProps) {
  ...
  return (
    <div className="space-y-5">
      ...
      <section className={`glass-card p-5 space-y-5 bg-linear-to-br ${gradient}`}>
        <div className="space-y-2">
          <p className="text-xs uppercase tracking-widest text-text-muted font-semibold">
            {exercise.category ? CATEGORY_LABELS[exercise.category] : "Exercise"}
          </p>
          <h1
        ...
        <div className="space-y-3">
          {exercise.videoUrl ? (
            ...
            <div className="glass-card p-3 space-y-3">
              <div className="overflow-hidden rounded-2xl border border-border-subtle bg-[#05060A]">
                <Image
            ...
            <div className="glass-card p-8 text-center text-sm text-text-muted">
              Media belum tersedia untuk exercise ini.
            </div>
          )}
        </div>
      </section>
