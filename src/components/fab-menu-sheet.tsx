      ...
      >
        ...
        <div className="space-y-3 pb-6">
          ...
          <button
            ...
            id="fab-guided-plan"
          >
            <div className="size-12 rounded-xl bg-linear-to-br from-emerald/20 to-emerald/5 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
              <ClipboardList className="size-6 text-emerald" aria-hidden="true" />
            </div>
            <div>
            ...
            <div className="ml-auto">
              <div className="size-8 rounded-full bg-emerald/10 flex items-center justify-center">
          ...
          <button
            ...
            id="fab-manual-log"
          >
            <div className="size-12 rounded-xl bg-linear-to-br from-blue-500/20 to-blue-500/5 flex items-center justify-center shrink-0 group-hover:scale-110 transition-transform">
              <Dumbbell className="size-6 text-blue-400" aria-hidden="true" />
            </div>
            <div>
